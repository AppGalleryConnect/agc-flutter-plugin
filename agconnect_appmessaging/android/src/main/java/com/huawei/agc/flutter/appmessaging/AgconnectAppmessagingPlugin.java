...
public class AgconnectAppmessagingPlugin implements FlutterPlugin, ActivityAware {
    ...
    private void initChannels(final BinaryMessenger messenger) {
        ...
        eventChannelOnMessageDismiss = new EventChannel(messenger, "com.huawei.agc.flutter.appmessaging_eventchannel_onMessageDismiss");
        eventChannelOnMessageClick = new EventChannel(messenger, "com.huawei.agc.flutter.appmessaging_eventchannel_onMessageClick");
        eventChannelOnMessageDisplay = new EventChannel(messenger, "com.huawei.agc.flutter.appmessaging_eventchannel_onMessageDisplay");
        eventChannelOnMessageError = new EventChannel(messenger, "com.huawei.agc.flutter.appmessaging_eventchannel_onMessageError");
        eventChannelCustomEvent = new EventChannel(messenger, "com.huawei.agc.flutter.appmessaging_eventchannel_customEvent");
    }

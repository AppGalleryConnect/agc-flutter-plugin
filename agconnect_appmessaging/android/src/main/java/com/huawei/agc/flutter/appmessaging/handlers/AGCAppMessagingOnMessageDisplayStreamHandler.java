...
public class AGCAppMessagingOnMessageDisplayStreamHandler implements StreamHandler {

    public AGCAppMessagingOnMessageDisplayStreamHandler(final Activity activity) {
    ...
    public void onListen(final Object arguments, final EventSink eventSink) {
        AGConnectAppMessaging.getInstance().addOnDisplayListener(appMessage -> {

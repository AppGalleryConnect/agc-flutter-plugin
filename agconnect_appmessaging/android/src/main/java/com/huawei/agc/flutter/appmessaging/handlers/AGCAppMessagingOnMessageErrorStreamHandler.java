...
public class AGCAppMessagingOnMessageErrorStreamHandler implements StreamHandler {

    public AGCAppMessagingOnMessageErrorStreamHandler(final Activity activity) {
    ...
    public void onListen(final Object arguments, final EventSink eventSink) {
        AGConnectAppMessaging.getInstance().addOnErrorListener(appMessage -> {

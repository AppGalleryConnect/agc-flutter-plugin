...
let AGCCloudFunctionsLog = AGCCloudFunctionsLogger(version: "1.2.0+301", service: "FlutterCloudFunctions")

/// Custom AGCCloudFunctionsLogger Class to listen api log events from Flutter Side.
